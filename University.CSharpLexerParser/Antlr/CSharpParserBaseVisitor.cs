...
public partial class CSharpParserBaseVisitor<Result> : AbstractParseTreeVisitor<Result>, ICSharpParserVisitor<Result> {
	...
	/// <summary>
	/// Visit a parse tree produced by <see cref="CSharpParser.cast_expression"/>.
	/// <para>
	/// The default implementation returns the result of calling <see cref="AbstractParseTreeVisitor{Result}.VisitChildren(IRuleNode)"/>
	/// on <paramref name="context"/>.
	/// </para>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitCast_expression([NotNull] CSharpParser.Cast_expressionContext context) { return VisitChildren(context); }
	/// <summary>
